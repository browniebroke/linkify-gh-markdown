...
Linkify GitHub Markdown could always use more documentation, whether as part of the official Linkify GitHub Markdown docs, in docstrings, or even on the web in blog posts, articles, and such.
...
2. Clone your fork locally:
   ...
   ```shell
   $ git clone git@github.com:your_name_here/linkify-gh-markdown.git
   ```
...
[gh-issues]: https://github.com/browniebroke/linkify-gh-markdown/issues
